...
FK_PREMIO_COD VARCHAR(20),
FK_JOGO_COD VARCHAR(10),
FK_EQUIPE_IDDAEQUIPE VARCHAR(15),
FK_COMPETICAO_CODIGO VARCHAR(20),
FOREIGN KEY(FK_PREMIO_COD) REFERENCES PREMIO (COD),
FOREIGN KEY(FK_JOGO_COD) REFERENCES JOGO (COD),
...
PRIMARY KEY(FK_PREMIO_COD,FK_JOGO_COD,FK_EQUIPE_IDDAEQUIPE0,FK_COMPETICAO_CODIGO)
);
